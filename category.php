			...
			<div class="container-fluid">
				<div class="row content div2">
					<div class="divc col-sm-12">
						<h3 class="btn btn-success buttonstyle">分类内容</h3><br/>
						<!--数据库调用代码-->
						<?php
							$category=$_GET['id'];
							/** 1.获取页面 **/
							...
							$sql = "SELECT * FROM posts where category='$category' order by post_id desc LIMIT ".($page-1)*$PageSize .",$PageSize";
							if(!$sql){
							echo "取出不成功";
							};
							//把sql语句传送到数据库
							...
							while($row = mysqli_fetch_assoc($result)){
								...
								//获取数据总数
								$to_sql="SELECT COUNT(*) FROM posts where category='$category'";
